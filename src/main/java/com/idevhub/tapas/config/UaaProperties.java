...
public class UaaProperties {
    ...
    public static class Mail {
        ...
        private int emailValidMinutes = 0;
        ...
        public int getEmailValidMinutes() {
            return emailValidMinutes;
        }

        public void setEmailValidMinutes(int emailValidMinutes) {
            this.emailValidMinutes = emailValidMinutes;
        }
    }
}
